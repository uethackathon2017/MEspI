...
class PlaylistConstain {
    ...
    public static let arrayCacLoaiQua = ["VL_VmGm7Fos","IDG3_J0TTXU","FW-gaSHE4tE","pgXJD1U0OG0","9JUxZWZSv1w","wyEIlJ5nWlQ","B9kPRI2DCJM"]
    public static let arrayTuVung = ["yQZvX2A8X40","hq3yfQnllfQ","js7rsiq-Gfo","a3qY1d1X4cs","BELlZKpi1Zs","e0dJWfQHF8Y"]
    public static let arrayDoDungHocTap = ["41cJ0mqWses","GJCE_vKIR_o","4GucJHccf48","hTobZFggexE","o6nQQraEN90","UiXMPYwaOkI"]
}
